...
## バージョン管理
- **現在のバージョン**: `1.20260425.06` (Beta) — 製品表記。npm の `package.json#version` は [semver](https://semver.org/) 準拠（先頭ゼロなしの整数表記）
- **最終更新日**: 2026-04-26
